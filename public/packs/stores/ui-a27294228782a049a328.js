...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/stores/ui.store.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./app/javascript/packs/stores/ui.store.ts":
/*!*************************************************!*\
  !*** ./app/javascript/packs/stores/ui.store.ts ***!
  \*************************************************/
/*! exports provided: Module, Action, NotificationLevel, default, store */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NotificationLevel", function() { return NotificationLevel; });
...
var UiStore = /** @class */ (function () {
    function UiStore() {
        ...
        this.selectModule = function (module) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.selectModule').data('module', module);
            _this.selectedModule = module;
        };
        this.selectAction = function (action) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.selectAction').data('action', action);
        ...
        this.addNotifications = function () {
            var notifications = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                notifications[_i] = arguments[_i];
            }
            var _a;
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.addNotification').data('notifications', notifications);
            if (notifications && notifications.length > 0) {
                (_a = _this.notifications).push.apply(_a, notifications);
            }
            else {
                _this.notifications.push({ level: NotificationLevel.Alert, message: 'Unknown error happened.' });
            }
        };
        this.dequeueNotification = function () {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.dequeueNotification').trace();
            _this.hasNotifications ? _this.notifications.shift() : false;
        };
        this.clearNotifications = function () {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.clearNotifications').trace();
            _this.notifications = [];
        };
        /* MODAL STATE */
        /**
        ...
        this.setQuery = function (query) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.setQuery').data('query', query);
            _this.query = query;
        };
        this.selectedModule = null;
        this.selectedAction = Action.Index;
        this.notifications = mobx__WEBPACK_IMPORTED_MODULE_0__["observable"].array([]);
        this.activePage = 1;
        this.itemsPerPage = 30;
    }
    UiStore.prototype.setMenuFixed = function (bool) {
        _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.setMenuFixed').data('bool', bool);
        this.menuFixed = bool;
    };
    Object.defineProperty(UiStore.prototype, "hasNotifications", {
        get: function () {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.hasNotifications').trace();
            return this.notifications.length > 0;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UiStore.prototype, "nextNotification", {
        get: function () {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.nextNotification').trace();
    ...
    ;
    UiStore.prototype.setModalOpen = function (bool) {
        _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.setModalOpen').data('bool', bool);
        this.modalOpen = bool;
    };
    UiStore.prototype.setModalContent = function (action) {
        _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.setModalContent').data('action', action);
        this.modalContent = action;
    };
    UiStore.prototype.setActivePage = function (page) {
        _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.setActivePage').data('page', page);
        this.activePage = page;
    };
    UiStore.prototype.updatePagination = function (numElements) {
        _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.updatePagination').trace();
        this.totalPages = Math.ceil(numElements / this.itemsPerPage);
        _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('UiStore.updatePagination').debug(this.totalPages + " pages total, " + this.itemsPerPage + " records per page, " + numElements + " items total");
    };
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", String)
    ], UiStore.prototype, "selectedModule", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], UiStore.prototype, "selectModule", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", String)
    ], UiStore.prototype, "selectedAction", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], UiStore.prototype, "selectAction", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Boolean)
    ], UiStore.prototype, "menuFixed", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Boolean]),
        __metadata("design:returntype", void 0)
    ], UiStore.prototype, "setMenuFixed", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
    ...
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], UiStore.prototype, "addNotifications", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["computed"],
        __metadata("design:type", Boolean),
        __metadata("design:paramtypes", [])
    ], UiStore.prototype, "hasNotifications", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["computed"],
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [])
    ], UiStore.prototype, "nextNotification", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], UiStore.prototype, "dequeueNotification", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], UiStore.prototype, "clearNotifications", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Boolean)
    ], UiStore.prototype, "modalOpen", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Boolean]),
        __metadata("design:returntype", void 0)
    ], UiStore.prototype, "setModalOpen", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", String)
    ], UiStore.prototype, "modalContent", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", void 0)
    ], UiStore.prototype, "setModalContent", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", String)
    ], UiStore.prototype, "query", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], UiStore.prototype, "setQuery", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Number)
    ], UiStore.prototype, "itemsPerPage", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Number)
    ], UiStore.prototype, "activePage", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", void 0)
    ], UiStore.prototype, "setActivePage", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Number)
    ], UiStore.prototype, "totalPages", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", void 0)
    ], UiStore.prototype, "updatePagination", null);
    return UiStore;
}());
...
/******/ });
//# sourceMappingURL=ui-a27294228782a049a328.js.map