...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/stores/product.store.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/common/logger.ts":
/*!***********************************************!*\
  !*** ./app/javascript/packs/common/logger.ts ***!
  \***********************************************/
...
/* WEBPACK VAR INJECTION */(function(process) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "logger", function() { return logger; });
var Level;
(function (Level) {
    Level[Level["ALL"] = 0] = "ALL";
    Level[Level["TRACE"] = 1] = "TRACE";
    Level[Level["DATA"] = 2] = "DATA";
...
var Logger = /** @class */ (function () {
    function Logger() {
        this.output = console;
        this.verbosity = process.env.SHOPPU_API_URL ? Level.ERROR : Level.ALL;
        this.resetPrefix();
    }
    Logger.prototype.of = function (name, block) {
        this.component = name;
        if (block) {
            this.block = "#" + block;
        }
    ...
    Logger.prototype.data = function (name, value) {
    ...
    Logger.prototype.printToLog = function () {
        var args = [];
        ...
        if (this.output && (this.level.valueOf() > this.verbosity.valueOf())) {
            (_a = this.output).log.apply(_a, args);
            this.resetPrefix();
        }
    };
    return Logger;
...
/***/ "./app/javascript/packs/stores/product.store.ts":
/*!******************************************************!*\
  !*** ./app/javascript/packs/stores/product.store.ts ***!
  \******************************************************/
...
/* harmony import */ var _common_logger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/logger */ "./app/javascript/packs/common/logger.ts");
/* harmony import */ var _simple_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./simple.store */ "./app/javascript/packs/stores/simple.store.ts");
...
var ProductStore = /** @class */ (function (_super) {
    ...
    function ProductStore() {
        ...
        _this.FIXERIO_KEY = '289a3992c9e255b4c5ba30aa0364f425';
        _this.applyExchangeRate = function (item) { return __awaiter(_this, void 0, void 0, function () {
            var base, symbol, exchange, rate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _common_logger__WEBPACK_IMPORTED_MODULE_2__["logger"].of('ProductStore.applyExchangeRate').data('item', item);
                        if (!(item !== null)) return [3 /*break*/, 4];
                        if (!(item.currency === item.displayCurrency)) return [3 /*break*/, 1];
                        item.displayPrice = item.price;
                        return [3 /*break*/, 3];
                    case 1:
                        base = item.currency, symbol = item.displayCurrency;
                        return [4 /*yield*/, this.getLatestExchange(base, symbol)];
                    case 2:
                        exchange = _a.sent();
                        if (exchange.data.success) {
                            rate = exchange.data.rates[symbol];
        ...
        _this.getLatestExchange = function (base, symbol) { return __awaiter(_this, void 0, void 0, function () {
            var url, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        url = "https://data.fixer.io/api/latest?access_key=" + this.FIXERIO_KEY + "&base=" + base + "&symbols=" + symbol;
                        return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } })];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_1 = _a.sent();
                        _common_logger__WEBPACK_IMPORTED_MODULE_2__["logger"].of('ProductStore.getRate').error(error_1);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
        }); };
        _this.modelName = 'product';
        _this.basePath = '/api/products';
        return _this;
    }
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_1__["action"],
        __metadata("design:type", Object)
    ], ProductStore.prototype, "applyExchangeRate", void 0);
    return ProductStore;
}(_simple_store__WEBPACK_IMPORTED_MODULE_3__["default"]));
...
/***/ "./app/javascript/packs/stores/rest.server.ts":
/*!****************************************************!*\
  !*** ./app/javascript/packs/stores/rest.server.ts ***!
  \****************************************************/
/*! exports provided: restServer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(process) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "restServer", function() { return restServer; });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _common_logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/logger */ "./app/javascript/packs/common/logger.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var RestServer = /** @class */ (function () {
    function RestServer() {
        ...
        this.VERBOSE = true;
        this.headers = {};
        this.handleError = function (error, verb) {
            if (error.response) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of("RestServer." + verb, 'handleError').error(error.response);
            }
            else if (error.request) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of("RestServer." + verb, 'handleError').error(error.request);
            }
            else {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of("RestServer." + verb, 'handleError').error(error.message);
            }
    ...
    RestServer.prototype.fetchAll = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(path)];
            });
        });
    };
    RestServer.prototype.fetchPaginated = function (path, page, per_page, query) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(path + '?' + ("page=" + page) + '&' + ("per_page=" + per_page) + '&' + ("query=" + query))];
            });
        });
    };
    RestServer.prototype.fetchById = function (path, id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(path + '/' + id)];
            });
        });
    };
    RestServer.prototype.get = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            var _this = this;
            return __generator(this, function (_a) {
                url = "" + this.restApiBaseUrl + path;
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.get').data('url', url);
                return [2 /*return*/, axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url)
                        .then(function (response) {
                        if (_this.VERBOSE) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.get').data('response.data', response.data);
                        }
                        return response.data;
                    })
                        .catch(function (error) { return _this.handleError(error, 'get'); })];
            });
        });
    };
    RestServer.prototype.delete = function (path, id) {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            var _this = this;
            return __generator(this, function (_a) {
                url = "" + this.restApiBaseUrl + path + "/" + id;
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.delete').data('url', url);
                if (this.MOCKED) {
                    _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.put').error('dummy operation: MOCK mode');
                    return [2 /*return*/, Promise.resolve(false)];
                }
                return [2 /*return*/, axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(url, { headers: this.headers })
                        .then(function (response) {
                        if (_this.VERBOSE) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.delete').data('response', response);
                        }
                        return response.data;
                    })
                        .catch(function (error) { return _this.handleError(error, 'delete'); })];
            });
        });
    };
    RestServer.prototype.put = function (path, id, json) {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            var _this = this;
            return __generator(this, function (_a) {
                url = "" + this.restApiBaseUrl + path + "/" + id;
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.put').data('url', url);
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.put').data('json', json);
                if (this.MOCKED) {
                    _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.put').error('dummy operation: MOCK mode');
                    return [2 /*return*/, Promise.resolve(false)];
                }
                return [2 /*return*/, axios__WEBPACK_IMPORTED_MODULE_0___default.a.put(url, json, { headers: this.headers })
                        .then(function (response) {
                        if (_this.VERBOSE) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.put').data('response', response);
                        }
                        return response.data;
                    })
                        .catch(function (error) { return _this.handleError(error, 'put'); })];
            });
        });
    };
    RestServer.prototype.post = function (path, json) {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            var _this = this;
            return __generator(this, function (_a) {
                url = "" + this.restApiBaseUrl + path;
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.post').data('url', url);
                if (this.MOCKED) {
                    _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.put').error('dummy operation: MOCK mode');
                    return [2 /*return*/, Promise.resolve(false)];
                }
                return [2 /*return*/, axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, json, { headers: this.headers })
                        .then(function (response) {
                        if (_this.VERBOSE) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('RestServer.post').data('response', response);
                        }
                        return response.data;
                    })
                        .catch(function (error) { return _this.handleError(error, 'post'); })];
            });
        });
    };
    return RestServer;
...
/***/ "./app/javascript/packs/stores/simple.store.ts":
/*!*****************************************************!*\
  !*** ./app/javascript/packs/stores/simple.store.ts ***!
  \*****************************************************/
...
/* harmony import */ var _common_logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/logger */ "./app/javascript/packs/common/logger.ts");
/* harmony import */ var _rest_server__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rest.server */ "./app/javascript/packs/stores/rest.server.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SimpleStore = /** @class */ (function () {
    function SimpleStore() {
         ...
         */
        this.api = _rest_server__WEBPACK_IMPORTED_MODULE_2__["restServer"];
        this.setSelectedItem = function (item) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.setSelectedItem').data('item', item);
            _this.selectedItem = item;
            _this.selectedItemIsDirty = false;
        };
        this.clearSelectedItem = function () {
            _this.setSelectedItem(null);
        };
        this.setOptions = function (options) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.setOptions').data('options', options);
            _this.options = options;
            _this.numOptions = _this.options.length;
        };
        this.setItems = function (items) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.setItems').data('items', items);
            if (_this.items && _this.numItems > 0) {
                _this.items = items.slice();
            }
            else {
                _this.items = items;
            }
            _this.numItems = _this.items.length;
        };
        this.clearItems = function () {
            _this.setItems([]);
        };
        this.setNumItems = function (count) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.setNumItems').data('count', count);
            _this.numItems = count;
        };
        this.setPaginatedItems = function (paginatedItems) {
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.setPaginatedItems').data('paginatedItems', paginatedItems);
            if (_this.paginatedItems && _this.paginatedItems.length > 0) {
                _this.paginatedItems = paginatedItems.slice();
            }
            else {
                _this.paginatedItems = paginatedItems;
            }
            _this.numPaginatedItems = _this.paginatedItems.length;
        };
        this.clearPaginatedItems = function () {
            _this.setPaginatedItems([]);
        };
        /* CRUD OPERATIONS */
        this.destroyItem = function (item) {
            ...
            if (_this.selectedItem) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.destroyItem').data('item', _this.selectedItem);
                _this.loading(true);
                return _this.api.delete(_this.basePath, _this.selectedItem.id)
                    .then(function (data) {
                    if (_this.numItems > 0) {
                        _this.setItems(_this.items.filter(function (item) { return item.id !== _this.selectedItem.id; }));
                        _this.setOptions(_this.options.filter(function (item) { return item.value !== _this.selectedItem.id; }));
                    }
                    _this.clearSelectedItem();
                    _this.loading(false);
                })
        ...
        this.updateItem = function (attrKeys, item) {
            var _a;
            if (item) {
                _this.setSelectedItem(item);
            }
            if (_this.selectedItem) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.updateItem').data('item', _this.selectedItem);
                var attrs = Object.keys(_this.selectedItem)
                    .reduce(function (object, key) {
                    if (attrKeys.indexOf(key) > -1) {
                        object[key] = _this.selectedItem[key];
                    }
                    return object;
                }, {});
                var json = (_a = {}, _a[_this.modelName] = attrs, _a);
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.updateItem').data('json', json);
                _this.loading(true);
                return _this.api.put(_this.basePath, _this.selectedItem.id, json)
                    .then(function (data) {
                    _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.updateItem', 'callback').data('data', data);
                    if (_this.numItems > 0) {
                        _this.getItems();
                        _this.getOptions();
                    }
        ...
        this.createItem = function (attrs) {
            var _a;
            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.createItem').data('attrs', attrs);
            var json = (_a = {}, _a[_this.modelName] = attrs, _a);
            _this.loading(true);
            return _this.api.post(_this.basePath, json)
                .then(function (data) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.createItem', 'callback').data('data', data);
                _this.getItems();
                _this.getOptions();
                _this.setSelectedItem(data);
                _this.loading(false);
    ...
    /* COMMON */
    SimpleStore.prototype.loading = function (state) {
        this.isLoading = state;
    };
    /* SELECTED ITEM */
    SimpleStore.prototype.getSelectedItem = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getSelectedItem').data('id', id);
                this.loading(true);
                return [2 /*return*/, this.api.fetchById(this.basePath, id)
                        .then(function (data) {
                        _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getSelectedItem', 'callback').data('data', data);
                        _this.setSelectedItem(data);
                        _this.loading(false);
                    })
                        .catch(function (error) {
    ...
    Object.defineProperty(SimpleStore.prototype, "selectedItemId", {
        get: function () {
    ...
    Object.defineProperty(SimpleStore.prototype, "selectedItemDisplayName", {
        get: function () {
    ...
    Object.defineProperty(SimpleStore.prototype, "hasItemSelected", {
        get: function () {
    ...
    /* HELPERS */
    SimpleStore.prototype.getOptions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getOptions').trace();
                this.loading(true);
                return [2 /*return*/, this.api.fetchAll(this.basePath + '/options')
                        .then(function (data) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getOptions', 'callback').data('data', data);
    ...
    /* ITEMS */
    SimpleStore.prototype.getItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getItems').trace();
                this.loading(true);
                return [2 /*return*/, this.api.fetchAll(this.basePath)
                        .then(function (data) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getItems', 'callback').data('data', data);
                            this.setItems(data);
                            this.loading(false);
                            return [2 /*return*/];
                        });
    ...
    SimpleStore.prototype.getNumItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getNumItems').debug('going to request items count');
                this.loading(true);
                return [2 /*return*/, this.api.get(this.basePath + '/count')
                        .then(function (data) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getNumItems', 'callback').data('data', data);
    ...
    /* PAGINATED ITEMS */
    SimpleStore.prototype.getPaginatedItems = function (page, per_page, query) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getPaginatedItems').debug("going to request paginated items for page " + page + ", " + per_page + " items per page");
                this.loading(true);
                return [2 /*return*/, this.api.fetchPaginated(this.basePath, page, per_page, query)
                        .then(function (data) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            _common_logger__WEBPACK_IMPORTED_MODULE_1__["logger"].of('SimpleStore.getPaginatedItems', 'callback').data('data', data);
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "isLoading", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Array)
    ], SimpleStore.prototype, "options", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Number)
    ], SimpleStore.prototype, "numOptions", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Array)
    ], SimpleStore.prototype, "items", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Number)
    ], SimpleStore.prototype, "numItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Array)
    ], SimpleStore.prototype, "paginatedItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Number)
    ], SimpleStore.prototype, "numPaginatedItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "selectedItem", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["observable"],
        __metadata("design:type", Boolean)
    ], SimpleStore.prototype, "selectedItemIsDirty", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Boolean]),
        __metadata("design:returntype", void 0)
    ], SimpleStore.prototype, "loading", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", Promise)
    ], SimpleStore.prototype, "getSelectedItem", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "setSelectedItem", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "clearSelectedItem", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["computed"],
        __metadata("design:type", Number),
        __metadata("design:paramtypes", [])
    ], SimpleStore.prototype, "selectedItemId", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["computed"],
        __metadata("design:type", String),
        __metadata("design:paramtypes", [])
    ], SimpleStore.prototype, "selectedItemDisplayName", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["computed"],
        __metadata("design:type", Boolean),
        __metadata("design:paramtypes", [])
    ], SimpleStore.prototype, "hasItemSelected", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], SimpleStore.prototype, "getOptions", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "setOptions", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], SimpleStore.prototype, "getItems", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "setItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "clearItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], SimpleStore.prototype, "getNumItems", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "setNumItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number, Number, String]),
        __metadata("design:returntype", Promise)
    ], SimpleStore.prototype, "getPaginatedItems", null);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "setPaginatedItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "clearPaginatedItems", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "destroyItem", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "updateItem", void 0);
    __decorate([
        mobx__WEBPACK_IMPORTED_MODULE_0__["action"],
        __metadata("design:type", Object)
    ], SimpleStore.prototype, "createItem", void 0);
    return SimpleStore;
}());
/* harmony default export */ __webpack_exports__["default"] = (SimpleStore);
...
/******/ });
//# sourceMappingURL=product-2b3408ce7075f9abd5f7.js.map